        ...
        <div className="container-fluid p-5">
            <div className="row gx-5">
                ...
                <div className="col-lg-7">
                    ...
                    <p className="mb-4">CitizenHub is your go-to platform for reporting and resolving various issues in our beautiful town of Hisarya. Whether it's illegal parking, noise pollution, public lighting problems, or road maintenance requests, we're here to ensure your concerns are heard and addressed promptly. Join us in making Hisarya a better place for everyone.</p>
